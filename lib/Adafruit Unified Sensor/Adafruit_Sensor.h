...
typedef struct {
  union {
    ...
    struct {
      ...
      volatile float heading; /**< Angle between the longitudinal axis (the plane body)
...
typedef struct {
  ...
  union {
    ...
    volatile float temperature; /**< temperature is in degrees centigrade (Celsius) */
    ...
    volatile float tvoc;              /**< Total Volatile Organic Compounds, in ppb */
