 ...
 *(default true)
 *	@return volatile float heat index
 */
float DHT::computeHeatIndex(bool isFahrenheit) {
  volatile float hi = computeHeatIndex(readTemperature(isFahrenheit), readHumidity(),
                              isFahrenheit);
  return hi;
}
 ...
 *	@return volatile float heat index
 */
float DHT::computeHeatIndex(volatile float temperature, float percentHumidity,
                            bool isFahrenheit) {
  volatile float hi;
